...
ImageUpload.prototype.handler = function(req, res, next, done) {
  this.req = req;
  this.res = res;
  this.next = next;
  this.callback = done;
...
ImageUpload.prototype.upload = function(imageData) {
  ...
  _this.blobService.createBlockBlobFromLocalFile(
    _this.storageContainer,
    blobName,
    imageData.path,
    fileOptions,
